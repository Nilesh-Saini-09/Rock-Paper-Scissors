...
const allGameIcons = document.querySelectorAll('.user');
...
function off() {
  ...
  function resetAll() {
      ...
      playerScore.classList.remove('winner');
        computerScore.classList.remove('winner');
      gameOver = false;
      stopConfetti();
      resetSelected();
  }
...
// Add selected styling in the computer choice
...
function updateScore(playerChoice) {
    if (playerChoice === computerChoice) {
        ...
        if(choice.defeats.indexOf(computerChoice) > -1) {
            ...
            if(!gameOver) {
                playerScoreNumber++;
                if(playerScoreNumber === winningScore ) {
            ...
            if(!gameOver) {
                computerScoreNumber++;
                if(computerScoreNumber === winningScore) {
